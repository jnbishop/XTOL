...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/action/.parts/packages/ruby2.1/2.1.3")
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/home/action/.parts/packages/ruby2.1/2.1.3"
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-march=x86-64 -mtune=generic -O2 -pipe -fstack-protector --param=ssp-buffer-size=4"
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  ...
  CONFIG["CFLAGS"] = "-march=x86-64 -mtune=generic -O2 -pipe -fstack-protector --param=ssp-buffer-size=4"
  CONFIG["CC"] = "gcc"
